...
function Complaint() {
  ...
  return (
    <>
      <Helmet>
        <title>Complaints | Battery Management System</title>
        <meta name="description" content="View and manage your battery-related complaints. Lodge new complaints and track their status." />
        <meta name="keywords" content="battery complaints, complaint management, battery issues, technical support" />
      </Helmet>
