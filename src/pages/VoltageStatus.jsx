...
const VoltageStatus = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Voltage Status | Battery Management System</title>
        <meta name="description" content="Monitor real-time voltage status across your battery systems. View and analyze voltage trends with interactive charts and filtering options." />
        <meta name="keywords" content="voltage monitoring, battery voltage, voltage status, voltage analysis, battery management system" />
        <meta property="og:title" content="Voltage Status | Battery Management System" />
        <meta property="og:description" content="Monitor and analyze real-time voltage status across your battery systems." />
        <meta property="og:type" content="website" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="Voltage Status | Battery Management System" />
        <meta name="twitter:description" content="Monitor and analyze real-time voltage status across your battery systems." />
      </Helmet>
