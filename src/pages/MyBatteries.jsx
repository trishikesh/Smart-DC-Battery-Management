...
function Home() {
  ...
  return (
    <>
      <Helmet>
        <title>My Batteries | Battery Management System</title>
        <meta name="description" content="View and manage your battery inventory. Monitor battery health, performance metrics, and add new batteries to your system." />
        <meta name="keywords" content="battery management, battery inventory, battery monitoring, battery health, battery metrics" />
        <meta property="og:title" content="My Batteries | Battery Management System" />
        <meta property="og:description" content="View and manage your battery inventory. Monitor battery health and performance metrics." />
