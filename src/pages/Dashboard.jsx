...
function Home() {
  ...
  return (
    <>
      <Helmet>
        <title>Dashboard | Battery Management System</title>
        <meta name="description" content="View your battery management dashboard with recent battery status, calendar events, and important notifications." />
        <meta name="keywords" content="battery dashboard, battery management, battery monitoring, battery status" />
      </Helmet>
