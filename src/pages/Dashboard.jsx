...
function Home() {
  return (
    <div className="flex min-h-screen bg-[#010009]">
      <Sidebar />

      <div className="flex-grow p-6 ml-64 flex flex-col justify-between">
        <div>
          ...
          <div className="grid grid-cols-12 gap-6">
            <div className="col-span-8 bg-[#1a1a1a] rounded-lg shadow-md p-4 border-2 border-blue-400">
              <h2 className="text-lg font-semibold mb-4 text-white">Recently Viewed</h2>
              <div className="flex flex-col space-y-3">
                <div className="flex items-center bg-[#010009] rounded-lg p-3 border border-blue-400">
